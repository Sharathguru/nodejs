    ...
    // let readStram1=fs.createReadStream("./index.txt",{highWaterMark:4,encoding:"utf-8"})

    // readStram1.on("data",(chunk)=>
    // {
    //     // console.log("-----Chunk----");
    //     console.log(chunk);
    // })
...
// readStram.pipe(gzip).pipe(writeStream)
    ...
    let writeStream=fs.createWriteStream("index1")
    writeStream.end("hello")


    let ReadStream1=fs.createReadStream("./index1.txt",{highWaterMark:2,encoding:"utf-8"})
