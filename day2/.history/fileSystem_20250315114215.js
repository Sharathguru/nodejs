...
// fs.unlinkSync("./React-app/src/index1.html")


// fs.writeFileSync("./React-app/src/COMPONENTS/Home.jsx","")
// fs.writeFileSync("./React-app/src/Main.jsx","")
// fs.writeFileSync("./React-app/src/index1.html","<h1>jhyt</h1>")

// fs.writeFileSync("./React-app/src/main.jsx","")---------it is used write the code and create the files
// fs.createWriteStream("./React-app/src/index12.html") ----it will create the file only
