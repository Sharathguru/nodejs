...
let File=async()=>
{
  try {
    fs.mkdir("./react-app")
    fs.mkdir("./react-app/public")
    fs.mkdir("./react-app/src")
    fs.mkdir("./react-app/src/component")
    fs.writeFile("./react-app/src/component/Home.jsx")
    fs.writeFile("./react-app/src/App.jsx")
    fs.writeFile("./react-app/src/index.html")
    fs.w
  } catch (error) {
